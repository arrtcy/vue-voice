<template>
  <section>
    <img
      class="img1"
      src="http://p1.music.126.net/-tNQI9Gokz7o-m9TrbRlwg==/109951165389737885.jpg?param=140y140"
      alt=""
    />
    <ul>
      <li class="new" v-for="(item, i) in list" :key="item.id">
        ...
        <van-icon
          :name="item.btn ? 'play-circle' : 'pause-circle'"
          size="0.3rem"
          @click="playList(item, item.btn, i)"
          color="white"
        />
      </li>
    </ul>
